...
func (tr *Kube) GetObservation() (map[string]interface{}, error) {
...
func (tr *Kube) SetObservation(obs map[string]interface{}) error {
...
func (tr *Kube) GetParameters() (map[string]interface{}, error) {
...
func (tr *Kube) SetParameters(params map[string]interface{}) error {
