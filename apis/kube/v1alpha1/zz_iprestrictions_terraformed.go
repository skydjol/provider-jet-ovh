...
func (tr *IpRestrictions) GetObservation() (map[string]interface{}, error) {
...
func (tr *IpRestrictions) SetObservation(obs map[string]interface{}) error {
...
func (tr *IpRestrictions) GetParameters() (map[string]interface{}, error) {
...
func (tr *IpRestrictions) SetParameters(params map[string]interface{}) error {
